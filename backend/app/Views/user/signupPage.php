...
<a href="<?= base_url('loginPage'); ?>" 
  ...
  <div class="relative z-10 bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl flex overflow-hidden w-[900px] h-[560px]">
    ...
    <div class="w-1/2 p-10 flex flex-col justify-center bg-white/90">
      <h2 class="text-2xl font-semibold text-orange-600 mb-6">Sign Up</h2>

      <form action="<?= base_url('signupPage'); ?>" method="post" class="space-y-4">
        <!-- First Name -->
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-gray-700">
          ...
          <a href="<?= base_url('loginPage'); ?>" class="text-orange-500 font-medium hover:underline">
            Log In Here
          </a>
        </p>
      </div>
